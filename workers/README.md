...
| [volume-estimator](volume-estimator/) | Estimates building volumes using swissALTI3D/swissSURFACE3D elevation models | Active | Python, FME | swissALTI3D, swissSURFACE3D |
